    ...
    public String readAll() {
        ...
        try {
            while ((line = bufferedReader.readLine()) != null) {
                ...
                switch (data[0]) {
                    case "socketNumber":
                        Definitions.socketNumber = Integer.parseInt(data[1]);
                        break;
                    case "serverURL":
                        Definitions.socketAddres = data[1];
                        break;
                    case "ID":
                        Definitions.id = Integer.parseInt(data[1]);
                        break;
                    case "ESTADO":
                        Definitions.estado = Integer.parseInt(data[1]);
                        break;
                    case "LAT":
                        Definitions.latitude = Double.parseDouble(data[1]);
                        break;
                    case "LNG":
                        Definitions.longitude = Double.parseDouble(data[1]);
                        break;
                    default:
                        break;
                }
